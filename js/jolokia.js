    ...
    var _jolokiaConstructorFunc = function ($) {
        ...
        function Jolokia(param) {
            ...
            this.request = function (request, params) {
                ...
                // Custom addition to add support for Bearer Token
                $.each(["username", "password", "timeout","token"], function (i, key) {
                    if (opts[key]) {
                ...
                if (ajaxParams['token']) {
                    ...
                    if (window.btoa) {
                        ajaxParams.beforeSend = function (xhr) {
                            xhr.setRequestHeader('Authorization', "Bearer " + ajaxParams['token']);
                        };
                    }
